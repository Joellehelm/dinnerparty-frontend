...
export const searchedRecipes = (searchTerms) => dispatch => {
    ...
    // const key = '1bb51352dd1242a78144cdf8f41248f7'
      ...
      fetch(URL + `&number=8&instructionsRequired=true&apiKey=${key}`)
      .then(r => r.json())
      .then(recipes => {
          console.log(URL + `&number=8&instructionsRequired=true&apiKey=${key}`)
       console.log(recipes)
          dispatch({
  ...
  export const fetchingRecipes = () => dispatch => {
      dispatch({
